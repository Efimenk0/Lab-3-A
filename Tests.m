...
- (void)testDisjunction {
    ...
    TernaryVectorClass::TernaryVector v3 =  Disjunction(v1, v2);
...
- (void)testConjunction {
    ...
    std::string str2 = "01X01X01";
    TernaryVectorClass::TernaryVector v2(str2);
    XCTAssertNoThrow(v1.Conjunction(v2));
...
- (void)testCompare {
    ...
    std::string str2 = "01X01X01";
    TernaryVectorClass::TernaryVector v2(str2);
    XCTAssertEqual(1, Compare(v1, v2));
    std::string str3 = "01X01X01";
    TernaryVectorClass::TernaryVector v3(str3);
    XCTAssertEqual(1, Compare(v1, v3));
    XCTAssertEqual(-2, Compare(v2, v3));
}
